...
def display_figures_6subplot(p_pv, p_bess_out, p_with, p_ue, p_bess_in, p_inj, e_bess_stor, p_elh_out,
                    p_ut, p_shared, p_cl_rec, p_cl_grid, p_cl_with, e_hss_stor, p_hss_out, p_hss_in, t_hss, d_cl,
                    p_grid_in, p_grid_out, diff_hss_out=None, diff_hss_in=None, params=None):
    global time, t_plot
    # One week in each season
    ...
    for i, t0 in enumerate(t0s):
        ...
        axes[0, 1].legend(handles + axtw_handles, labels + axtw_labels, fontsize=fontsize, loc='center', ncol=2)
        axes[0, 1].axis('off')
